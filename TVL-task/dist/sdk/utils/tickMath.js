...
class TickMath {
    ...
    static getSqrtRatioAtTick(tick) {
        ...
        if (tick > 0)
            ratio = constant_1.MaxUint256 / ratio;
        // back to Q96
        return ratio % Q32 > constant_1.ZERO ? ratio / Q32 + constant_1.ONE : ratio / Q32;
    }
    /**
    ...
    static getTickAtSqrtRatio(sqrtRatioX96) {
        (0, tiny_invariant_1.default)(sqrtRatioX96 >= TickMath.MIN_SQRT_RATIO && sqrtRatioX96 < TickMath.MAX_SQRT_RATIO, 'SQRT_RATIO');
